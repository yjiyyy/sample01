// Demo_Play_Weapons : Description : Use to play sounds on demo scene
...
{
	public class Demo_Play_Weapons : MonoBehaviour
	{
		...
		{                                                           // -> Init
			...
			var tmp_NumberOfSample = 0;                                     // Use for demo to know the name of the sample used
