...
public class RagdollBuildSettings : ScriptableObject
{
    ...
    public static BoneOverride[] GetE_LV01PresetOverrides()
    {
        return new BoneOverride[]
        {
            ...
            new BoneOverride { boneKey = "LeftElbow", mass = 2f, colliderRadius = 0.07f, colliderHeight = 0.2f, colliderDirection = 0, colliderCenter = new Vector3(-0.14f, 0f, 0f), jointAxis = new Vector3(0f, 0f, -1f), jointSwingAxis = new Vector3(1f, 0f, 0f), lowTwistLimit = 35f, highTwistLimit = 130f, swing1Limit = 30f, swing2Limit = 30f },
            ...
            new BoneOverride { boneKey = "RightElbow", mass = 2f, colliderRadius = 0.07f, colliderHeight = 0.2f, colliderDirection = 0, colliderCenter = new Vector3(-0.1f, 0f, 0f), jointAxis = new Vector3(0f, 0f, -1f), jointSwingAxis = new Vector3(1f, 0f, 0f), lowTwistLimit = 35f, highTwistLimit = 130f, swing1Limit = 30f, swing2Limit = 30f },
        };
    }
